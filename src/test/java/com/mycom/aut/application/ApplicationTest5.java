...
public class ApplicationTest5 extends BaseTest {
    ...
    @Test(priority=0, dataProvider = "loginDataFromJson",dataProviderClass = BaseTest.class, dependsOnMethods= {"navigateToLoginPage"})
     public void testWithMultipleUserFromJson (String email, String password) {
    	try {
